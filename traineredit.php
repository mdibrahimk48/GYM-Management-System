...
$connect=mysqli_connect("localhost","root","","m3_fitness");
			...
			if(@$_GET){
				...
				$trainer_address=$_GET["trainer_address"];
				$trainer_email=$_GET["trainer_email"];
				$trainer_mobile=$_GET["trainer_mobile"];
				$start_time=$_GET["start_time"];
				$end_time=$_GET["end_time"];
				$start_time=$_GET["start_time"];
				$trainer_gender=$_GET["trainer_gender"];
				$trainer_image=$_GET["trainer_image"];
			}
			if(@$_POST['edit']){
				$ts_id=$_POST["ts_id"]; echo $ts_id;
				...
				if($trainer_name==null||$trainer_address==null||$trainer_email==null||
					null||$trainer_mobile==null||$start_time==null||$end_time==null||$trainer_image==null){
					echo "<center>Some of The Fields Are Blank. Please Insert Data.</center>";
						...
						if ((($_FILES["trainer_image"]["type"] == "image/gif")
						 ...
						 && ($_FILES["trainer_image"]["size"] < 50000000)){
							...
							$query="update trainerschedule set trainer_name='$trainer_name',trainer_address='$trainer_address', trainer_email='$trainer_email',trainer_mobile='$trainer_mobile',start_time='$start_time',end_time='$end_time',trainer_gender='$trainer_gender',trainer_image='image/$trainer_image' where ts_id='$ts_id'";
							...
							if(!$result){
								...
								echo "<center>Data of Trainer Is Edited!</center>";
							}
			...
			<div class="contact">				
				...
				<div class="col span_2_of_3">
				  <div class="contact-form">
				  	<h3>Trainer Edit From</h3>
					    <form method="post" action="traineredit.php" enctype="multipart/form-data">
					    	<div>
						    	<span><label>Name <font color="red">*</font></label></span>
						    	<span><input name="trainer_name" id="trainer_name" type="text" class="trainer_name" pattern="[A-Za-z' -.]+" required="" value="<?php echo $trainer_name; ?>" /></span>
						    </div>
						    <input type="hidden" name="ts_id" value="<?php echo $ts_id?>">
							
							<div>
						    	<span><label>Address <font color="red">*</font></label></span>
						    	<span><input name="trainer_address" id="trainer_address" type="text" class="trainer_address"pattern="[A-Za-z' -.]+" required="" value="<?php echo $trainer_address; ?>" /></span>
						    </div>
						    <div>
						    	<span><label>E-mail</label></span>
						    	<span><input name="trainer_email" id="trainer_email" type="email" class="trainer_email" required="" value="<?php echo $trainer_email; ?>" /></span>
						    </div>
						     <div>
							 <span><label>Mobile <font color="red">*</font></label></span>
						    	<span><input name="trainer_mobile" id="trainer_mobile" type="text" class="trainer_mobile" pattern="[0-9]{11}"  required="" value="<?php echo $trainer_mobile; ?>" /></span>
						    </div>
						    
						     <div>
							 <span><label>Start Time <font color="red">*</font></label></span>
						    	<span><input name="start_time" id="start_time" type="time" class="start_time"  required="" value="<?php echo $start_time; ?>" /></span>
						    </div>
						    <div>
							 <span><label>End Time <font color="red">*</font></label></span>
						    	<span><input name="end_time" id="end_time" type="time" class="end_time"  required="" value="<?php echo $end_time; ?>" /></span>
						    </div>
								<div class="combo"> 
					...
					<input class="trainer_image" type="file" id="trainer_image" name="trainer_image"  required="" value="<?php echo $trainer_address; ?>" />
					</div>
						   <div>
						   		<span><input type="submit" id="edit" name="edit" class="submit" value="Edit"></span>
						  </div>
					    </form>

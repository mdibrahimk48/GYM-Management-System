...
<div class="content">
		...
		/*echo "<center><table style='border:5px solid; border-spacing:30px; border-collapse:separate;'>";
			echo "<tr style=' border-bottom: 1px solid black;'>";
				...
				echo "<th>Medicine Price</th>";
				echo "<th>Medicine Photo</th>";
		...
		if($result){
			while($row= mysqli_fetch_array($result,MYSQLI_ASSOC)){
				...
				/*echo "<tr style=' border-bottom: 1px solid black;'>";
					...
					echo "<td><a href='ordermedicine.php?event=order&m_no=$m_no&m_name=$m_name&m_price=$m_price'>Order Now</a></td>";
					
				echo "</tr>";*/
				?>
				 <div class="grid">
					<a href="#"><img src="<?php echo $m_image ?>" style="height:150px;width:150px;"></a>
					<h2>Name:<?php echo $m_name ?></h2>
					<h4>Price:<?php echo $m_price ?></h4>
					<div class="grid_p" >
					<p><?php echo $m_detail ?></p>
					</div>
					<?php if (isset($_SESSION['login'])) { ?>
						<p><?php echo	"<a href='ordermedicine.php?event=order&m_no=$m_no&m_name=$m_name&m_price=$m_price'>Order Now</a>";?></p>
					<?php } ?>
